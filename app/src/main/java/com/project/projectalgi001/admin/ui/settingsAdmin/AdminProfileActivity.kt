...
import com.project.projectalgi001.databinding.ActivityAdminProfileBinding
...
class AdminProfileActivity : AppCompatActivity() {
        ...
        try {
            selectedPhoto?.let {
                if (Build.VERSION.SDK_INT < 28) {
                    ...
                    binding.imageProfileAdmin.setImageBitmap(bitmap)
                } else {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val toolbar: Toolbar = binding.toolbarProfileAdmin
        ...
        binding.imageProfileAdmin.setOnClickListener {
        ...
        binding.buttonSaveProfileAdmin.setOnClickListener {
            if (!isNetworkAvailable(this)){
                showDialogConnection()
            }else {
                customProggress!!.show()
                updateImageNamesAdminToFireStorage()
            }
        }
    ...
    private fun fetchAdmin() {
        val nameProfile = binding.textInputEditTextPNameAdmin as TextView
        val imageHeader = binding.imageProfileAdmin as ImageView
    ...
    private fun updateImageNamesAdminToFireStorage() {
        ...
        val uid = auth.currentUser?.uid
        val username = binding.textInputEditTextPNameAdmin.text.toString()
