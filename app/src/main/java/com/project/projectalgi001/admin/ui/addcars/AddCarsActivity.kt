...
import com.project.projectalgi001.databinding.ActivityAddCarsBinding
import java.util.*
...
class AddCarsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val toolbar: Toolbar = binding.toolbarAc
        ...
        tracker = SelectionTracker.Builder(
                ...
                MyItemDetailsLookup(binding.rvAddCars),
        ...
        binding.saveCar.setOnClickListener {
            ...
            if (binding.textInputEditTextAcNameCar.text.toString().isEmpty()) {
                binding.textInputEditTextAcNameCar.error = getString(R.string.field_empty)
                binding.textInputEditTextAcNameCar.requestFocus()
                return@setOnClickListener
            }

            if (binding.textInputEditTextAcPoliceNumber.text.toString().isEmpty()) {
                binding.textInputEditTextAcPoliceNumber.error = getString(R.string.field_empty)
                binding.textInputEditTextAcPoliceNumber.requestFocus()
                return@setOnClickListener
            }

            if (binding.textInputEditTextAcMachineNumber.text.toString().isEmpty()) {
                binding.textInputEditTextAcMachineNumber.error = getString(R.string.field_empty)
                binding.textInputEditTextAcMachineNumber.requestFocus()
                return@setOnClickListener
            }

            if (binding.textInputEditTextAcChassisNumber.text.toString().isEmpty()) {
                binding.textInputEditTextAcChassisNumber.error = getString(R.string.field_empty)
                binding.textInputEditTextAcChassisNumber.requestFocus()
                return@setOnClickListener
            }

            if (binding.textInputEditTextAcBpkb.text.toString().isEmpty()) {
                binding.textInputEditTextAcBpkb.error = getString(R.string.field_empty)
                binding.textInputEditTextAcBpkb.requestFocus()
                return@setOnClickListener
            }

            if (binding.textInputEditTextAcStnk.text.toString().isEmpty()) {
                binding.textInputEditTextAcStnk.error = getString(R.string.field_empty)
                binding.textInputEditTextAcStnk.requestFocus()
                return@setOnClickListener
            }

            if (binding.textInputEditTextAcCashPrice.text.toString().isEmpty()) {
                binding.textInputEditTextAcCashPrice.error = getString(R.string.field_empty)
                binding.textInputEditTextAcCashPrice.requestFocus()
                return@setOnClickListener
            }

            if (binding.textInputEditTextAcCreditPrice.text.toString().isEmpty()) {
                binding.textInputEditTextAcCreditPrice.error = getString(R.string.field_empty)
                binding.textInputEditTextAcCreditPrice.requestFocus()
                return@setOnClickListener
            }

            if (binding.textInputEditTextAcDp.text.toString().isEmpty()) {
                binding.textInputEditTextAcDp.error = getString(R.string.field_empty)
                binding.textInputEditTextAcDp.requestFocus()
                return@setOnClickListener
            }

            if (gridImagesUploaded.isEmpty()) {
                val alertBuilder = AlertDialog.Builder(this)
                alertBuilder.setTitle(getString(R.string.failed_add_cars))
                alertBuilder.setMessage(getString(R.string.uploadImage))
            ...
            if (!isNetworkAvailable(this)){
                ...
                uploadImageCarsToFireStorage()
            }
        }
    }

    private fun uploadImageCarsToFireStorage() {
    ...
    private fun saveDataCarsToCloudFirestore() {
        val id = binding.textInputEditTextAcPoliceNumber.text.toString()
        val imageCars : HashMap<String, String> = HashMap()
        val statusCar = true
        val cars = DataCars(statusCar, binding.textInputEditTextAcNameCar.text.toString(),
                binding.textInputEditTextAcPoliceNumber.text.toString(),
                binding.textInputEditTextAcMachineNumber.text.toString(),
                binding.textInputEditTextAcChassisNumber.text.toString(),
                binding.textInputEditTextAcBpkb.text.toString(),
                binding.textInputEditTextAcStnk.text.toString(),
                binding.textInputEditTextAcCashPrice.text.toString(),
                binding.textInputEditTextAcCreditPrice.text.toString(),
                binding.textInputEditTextAcDp.text.toString(),
                imageCars)

        for (i in 0 until saveImagesUrl.size) {
            imageCars["imagesCar$i"] = saveImagesUrl[i]
        }
        ...
        db.document("cars/$id")
                ...
                .addOnSuccessListener {
                    ...
                    alertBuilder.setMessage(getString(R.string.success_add_car))
                    alertBuilder.setPositiveButton(getString(R.string.oke)) { _, _->
    ...
    private fun showRecyclerGrid() {
        binding.rvAddCars.layoutManager = GridLayoutManager(this, 2)
        binding.rvAddCars.setHasFixedSize(true)
        binding.rvAddCars.adapter = adapter
    }
    ...
    private fun createAlert(alertTitle: String?, alertMessage: String?, positiveButtonText: String?,
