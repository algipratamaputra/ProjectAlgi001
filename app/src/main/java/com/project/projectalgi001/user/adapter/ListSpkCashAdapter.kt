...
import com.project.projectalgi001.user.ui.spk.DetailSpkCashActivity

class ListSpkCashAdapter(private val listSpkCash : ArrayList<FetchSpkCashModel>) : RecyclerView.Adapter<ListSpkCashAdapter.ListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            val intent = Intent(it.context, DetailSpkCashActivity::class.java)
            intent.putExtra(DetailSpkCashActivity.EXTRA_SPK_CASH, spkCashIntent)
            intent.putExtra(NAME_CAR, spkCash.carNameCash)
